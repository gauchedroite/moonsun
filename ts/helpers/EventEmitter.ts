...
class EventEmitter {
     ...
     */
    flattenListeners = function flattenListeners(listeners) {
        var flatListeners = [];
        var i;
     ...
     * @return {Object} Current instance of EventEmitter for chaining.
     */
    defineEvent = function defineEvent(evt) {
     ...
     * @return {Object} Current instance of EventEmitter for chaining.
     */
    addListeners = function addListeners(evt, listeners) {
     ...
     * @return {Object} Current instance of EventEmitter for chaining.
     */
    removeListeners = function removeListeners(evt, listeners) {
        // Pass through to manipulateListeners
     ...
     * @return {Object} Current instance of EventEmitter for chaining.
     */
    manipulateListeners = function manipulateListeners(remove, evt, listeners) {
        var i;
        var value;
     ...
     * @return {Object} Current instance of EventEmitter for chaining.
     */
    setOnceReturnValue = function setOnceReturnValue(value) {
     ...
     * @api private
     */
    private _getOnceReturnValue = function _getOnceReturnValue() {
     ...
     * @api private
     */
    private _getEvents = function _getEvents() {
